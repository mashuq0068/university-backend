...
router.post('/create-academic-department' , reqValidation(academicDepartmentValidations.createAcademicDepartmentValidationSchema) , asyncHandler(academicDepartmentControllers.createAcademicDepartment))
